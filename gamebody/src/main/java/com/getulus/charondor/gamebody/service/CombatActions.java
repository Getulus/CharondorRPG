...
public class CombatActions {
    ...
    public void fight() {
        ...
        while (monsterHealth > 0 && playerHealth > 0) {
            if (rounds % 2 == 0) {
                double playerDamage = restTemplate.getForEntity("http://192.168.0.17:8762/action/fight/player-attack", double.class).getBody();;
                ...
                double monsterDamage = restTemplate.getForEntity("http://192.168.0.17:8762/action/fight/monster-attack", double.class).getBody();
